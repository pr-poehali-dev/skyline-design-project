    ...
    <footer className="py-16 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-sm text-muted-foreground">2026 LogiFlow. Все права защищены.</p>
        </div>

        <div className="mt-20 text-center">
          <span className="font-serif text-[12rem] md:text-[16rem] leading-none text-border/50 select-none">L</span>
        </div>
      </div>
    </footer>
  );
